...
export const metadata: Metadata = {
  title: "Contact Tongli Timber in Arabic | Wood Veneer & Panels",
  description:
  ...
  return (
    <main style={styles.page}>
      <div style={styles.wrapper}>
        <span style={styles.badge}>Pilot · العربية</span>
        <h1 style={styles.title}>Contact Tongli Timber</h1>
        <p style={styles.subtitle}>Arabic contact page pilot</p>

        <section style={styles.card}>
          <p style={styles.paragraph}>
            This is a pilot Arabic contact page. Please contact Tongli Timber
