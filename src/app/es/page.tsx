export const metadata = {
  title: "Spanish Page Pilot | Tongli Timber",
  description: "Pilot Spanish multilingual page for Tongli Timber.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function SpanishPilotPage() {
  return (
    <main className="min-h-screen bg-[#FAF7F0] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-sm border border-stone-200 p-10 text-center">
        ...
        <p className="text-base text-stone-700 leading-relaxed mb-10">
          This is a pilot multilingual page. Full Spanish content will be
          added later.
        </p>
        <a
          href="/"
