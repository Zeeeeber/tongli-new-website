      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl font-bold text-[#1F2621] mb-4"><T>{"About 3D Wood Panels"}</T></h2>
            <p className="text-[#6b7280] leading-relaxed">
              <T>{"3D wood panels are crafted from solid wood with precision carving to create stunning three-dimensional textures and patterns. These decorative panels add architectural interest and visual depth to any space, making them a favorite among interior designers for feature walls, ceiling treatments, and furniture accents.\n            "}</T></p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-[#6b7280] mt-4">
              <T>{"Showing "}</T><span className="font-medium text-[#1F2621]">{threeDWoodPanelsProducts.length}</span> <T>{"products in 3D Wood Panels\n            "}</T></p>
          </div>
      ...
      <section className="py-16" style={{ backgroundColor: accentColor }}>
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center text-white">
            <h2 className="text-3xl font-bold mb-4"><T>{"Need 3D Wood Panels?"}</T></h2>
            <p className="text-white/80 mb-8"><T>{"Contact us for pattern availability, custom development, and sample requests."}</T></p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="px-8 py-4 bg-white rounded-lg font-semibold hover:bg-[#F7F3EC] transition-colors" style={{ color: accentColor }}><T>{"Contact Us"}</T></Link>
