      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <span className="text-[#1F2621] font-medium">Industry News</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90">
              Stay informed about wood industry trends, market updates, 
          ...
          {categoryArticles.length > 0 ? (
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-[#FDFBF7] rounded-2xl p-12 border border-[#E5E1D8] text-center">
                ...
                <h2 className="text-2xl font-bold text-[#1F2621] mb-4">No Industry News Yet</h2>
                <p className="text-[#6b7280] mb-8 max-w-md mx-auto">
                  We are preparing insightful articles about wood industry trends, 
