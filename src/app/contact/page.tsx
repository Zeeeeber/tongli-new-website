...
const PHONE_E164 = "+8615817587053";
...
export default function ContactPage() {
  ...
  useEffect(() => {
    // Verify the QR asset actually exists on the server so we can show a
    // graceful "Coming Soon" placeholder instead of a broken image.
    let cancelled = false;
          ...
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="text-base text-[#6b7280] leading-relaxed max-w-2xl mb-10">
                Contact Tongli Timber for wood veneer, decorative panels,
                engineered veneer, 3D wood panels, melamine boards and
                supporting board materials. Send us your required size,
                thickness, surface finish, substrate or application, and our
                team will help recommend suitable materials for your project.
              </p>
              ...
              <div className="bg-white rounded-3xl p-7 lg:p-9 shadow-lg border border-[#E5E1D8] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#6b7280] leading-relaxed mb-7">
                    Send us your product requirements, sizes, surface finish or
                    project details directly.
                  </p>

                  <div className="flex justify-center">
                    <div
                      className="relative w-full max-w-[260px] aspect-square rounded-2xl overflow-hidden border border-[#E5E1D8] bg-[#FAFAFA] flex items-center justify-center"
                      aria-label="WhatsApp QR code"
                    >
                      {qrAvailable === null && (
                        <div className="w-full h-full bg-[#FAFAFA]" aria-hidden />
                      )}
                      {qrAvailable === true && (
                        <Image
                          src={QR_IMAGE_SRC}
                          alt="WhatsApp QR code for Tongli Timber"
                          fill
                      ...
                      {qrAvailable === false && (
                        <div className="text-center px-6 py-8">
                          ...
                          <p className="text-sm font-semibold text-[#1F2621] mb-1">
                            WhatsApp QR Code Coming Soon
                          </p>
                          <p className="text-xs text-[#9CA3AF]">
                            Tap the WhatsApp card on the left to chat with us
                            directly.
                          </p>
                        </div>
                      )}
