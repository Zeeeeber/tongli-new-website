  ...
  return (
    <>
      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <span className="text-[#1F2621] font-medium">Wall Panels & Interior</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-white/80 text-sm">Wall Panels & Interior</span>
              </div>

              <h1 className="text-3xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Wood Veneer Panels for
                <span className="block text-[#C4E0CC]">Wall Panels & Interior</span>
              </h1>

              <p className="text-lg text-white/80 mb-6 max-w-2xl leading-relaxed">
                Natural and decorative wood surface materials for wall panels, feature walls, ceilings and interior decoration projects.
              </p>
              ...
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden">
                  <span className="text-white/70 text-sm text-center px-4">
                    [Wall panels and interior decoration image]<br /><br />
                    - Hotel wall panel installation<br />
                    - Feature wall with wood veneer<br />
                    - 3D panel decorative effect<br />
                    - Large area interior application
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#4C8A68] text-sm font-semibold tracking-widest uppercase mb-4">Key Concerns</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">What Interior Designers Really Care About</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              We understand the priorities in wall panel and interior projects. Here is what matters most to our clients.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#4C8A68] text-sm font-semibold tracking-widest uppercase mb-4">Problem Analysis</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">Common Problems in Wall Panel Projects</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              These are the real challenges wall panel projects face. Understanding them helps us provide better solutions.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#4C8A68] text-sm font-semibold tracking-widest uppercase mb-4">Our Solutions</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">How Tongli Solves Your Wall Panel Challenges</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              Our practical solutions are backed by factory expertise and years of experience serving wall panel projects.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#4C8A68] text-sm font-semibold tracking-widest uppercase mb-4">Material Guide</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">Recommended Material Combinations</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              Select the right combination based on your wall panel type and requirements.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <span className="inline-block text-[#4C8A68] text-sm font-semibold tracking-widest uppercase mb-4">FAQ</span>
              <h2 className="text-3xl font-bold text-[#1F2621]">Frequently Asked Questions</h2>
              <p className="text-[#6b7280] mt-2">Questions specific to wall panel and interior material sourcing.</p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Need Decorative Wood Surfaces for Wall Panels?
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-xl mx-auto">
              Send us your space type, design reference, size, surface style and quantity.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <Link href="/products" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#4C8A68]">View All Products</span>
            </Link>
            <Link href="/collections" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#4C8A68]">Browse Collections</span>
            </Link>
            <Link href="/applications" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#4C8A68]">All Applications</span>
            </Link>
            <Link href="/contact" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#4C8A68]">Contact Us</span>
            </Link>
          </div>
        </div>
      </section>
