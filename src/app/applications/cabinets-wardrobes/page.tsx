  ...
  return (
    <>
      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <span className="text-[#1F2621] font-medium"><T>{"Cabinets & Wardrobes"}</T></span>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-white/80 text-sm"><T>{"Cabinets & Wardrobes"}</T></span>
              </div>

              <h1 className="text-3xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                <T>{"Decorative Panels for\n                "}</T><span className="block text-[#4C8A68]"><T>{"Cabinets and Wardrobes"}</T></span>
              </h1>

              <p className="text-lg text-white/80 mb-6 max-w-2xl leading-relaxed">
                <T>{"Coordinated veneer panels, melamine boards, substrates and matching edge banding for cabinet, wardrobe and storage system production.\n              "}</T></p>
              ...
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden">
                  <span className="text-white/70 text-sm text-center px-4">
                    <T>{"[Cabinets and wardrobes application image]"}</T><br /><br />
                    <T>{"- Cabinet factory production"}</T><br />
                    <T>{"- Color-matched panel systems"}</T><br />
                    <T>{"- Edge banding matching"}</T><br />
                    <T>{"- Finished cabinet products\n                  "}</T></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#124B34] text-sm font-semibold tracking-widest uppercase mb-4"><T>{"Key Concerns"}</T></span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4"><T>{"What Cabinet Manufacturers Really Care About"}</T></h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              <T>{"We understand the priorities in cabinet and wardrobe production. Here is what matters most to our clients.\n            "}</T></p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#124B34] text-sm font-semibold tracking-widest uppercase mb-4"><T>{"Problem Analysis"}</T></span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4"><T>{"Common Problems in Cabinet Production"}</T></h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              <T>{"These are the real challenges cabinet factories face. Understanding them helps us provide better solutions.\n            "}</T></p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#124B34] text-sm font-semibold tracking-widest uppercase mb-4"><T>{"Our Solutions"}</T></span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4"><T>{"How Tongli Solves Your Cabinet Challenges"}</T></h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              <T>{"Our practical solutions are backed by factory expertise and years of experience serving cabinet manufacturers.\n            "}</T></p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#124B34] text-sm font-semibold tracking-widest uppercase mb-4"><T>{"Material Guide"}</T></span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4"><T>{"Recommended Material Combinations"}</T></h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              <T>{"Select the right combination based on your cabinet type and production requirements.\n            "}</T></p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <span className="inline-block text-[#124B34] text-sm font-semibold tracking-widest uppercase mb-4"><T>{"FAQ"}</T></span>
              <h2 className="text-3xl font-bold text-[#1F2621]"><T>{"Frequently Asked Questions"}</T></h2>
              <p className="text-[#6b7280] mt-2"><T>{"Questions specific to cabinet and wardrobe material sourcing."}</T></p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              <T>{"Need Matching Decorative Boards for Cabinets?\n            "}</T></h2>
            <p className="text-xl text-white/80 mb-8 max-w-xl mx-auto">
              <T>{"Send us your color system, substrate, thickness and quantity. We will recommend the right materials for your cabinet production.\n            "}</T></p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <Link href="/products" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#124B34]"><T>{"View All Products"}</T></span>
            </Link>
            <Link href="/collections" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#124B34]"><T>{"Browse Collections"}</T></span>
            </Link>
            <Link href="/applications" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#124B34]"><T>{"All Applications"}</T></span>
            </Link>
            <Link href="/contact" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#124B34]"><T>{"Contact Us"}</T></span>
            </Link>
          </div>
        </div>
      </section>
