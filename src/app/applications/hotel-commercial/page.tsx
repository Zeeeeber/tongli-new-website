  ...
  return (
    <>
      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <span className="text-[#1F2621] font-medium">Hotel & Commercial</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-white/80 text-sm">Hotel & Commercial</span>
              </div>

              <h1 className="text-3xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Wood Materials for
                <span className="block text-[#D4B896]">Hotel & Commercial Interiors</span>
              </h1>

              <p className="text-lg text-white/80 mb-6 max-w-2xl leading-relaxed">
                Project-ready decorative wood surface solutions with sample approval, batch consistency and export packaging support.
              </p>
              ...
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden">
                  <span className="text-white/70 text-sm text-center px-4">
                    [Hotel and commercial interiors image]<br /><br />
                    - Hotel lobby with wood veneer<br />
                    - Commercial space wall panels<br />
                    - Restaurant feature wall<br />
                    - Multi-area material coordination
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#8B6914] text-sm font-semibold tracking-widest uppercase mb-4">Key Concerns</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">What Project Managers Really Care About</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              We understand the priorities in commercial projects. Here is what matters most to our hotel and commercial clients.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#8B6914] text-sm font-semibold tracking-widest uppercase mb-4">Problem Analysis</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">Common Challenges in Commercial Projects</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              These are the real challenges commercial projects face. Understanding them helps us provide better solutions.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#8B6914] text-sm font-semibold tracking-widest uppercase mb-4">Our Solutions</span>
            <h2 className="text-3xl font-bold text-[#1F2621] mb-4">How Tongli Supports Commercial Projects</h2>
            <p className="text-[#6b7280] max-w-2xl mx-auto">
              Our practical solutions are backed by factory expertise and years of experience serving hotel and commercial projects.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F7F3EC]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block text-[#8B6914] text-sm font-semibold tracking-widest uppercase mb-4">Material Guide</span>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <span className="inline-block text-[#8B6914] text-sm font-semibold tracking-widest uppercase mb-4">FAQ</span>
              <h2 className="text-3xl font-bold text-[#1F2621]">Frequently Asked Questions</h2>
              <p className="text-[#6b7280] mt-2">Questions specific to hotel and commercial project material sourcing.</p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Need Project-Ready Wood Surface Materials?
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-xl mx-auto">
              Send us your project type, sample requirement, surface style, delivery plan and quantity.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <Link href="/products" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#8B6914]">View All Products</span>
            </Link>
            <Link href="/collections" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#8B6914]">Browse Collections</span>
            </Link>
            <Link href="/applications" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#8B6914]">All Applications</span>
            </Link>
            <Link href="/contact" className="group">
              <span className="text-sm font-medium text-[#1F2621] group-hover:text-[#8B6914]">Contact Us</span>
            </Link>
          </div>
        </div>
      </section>
