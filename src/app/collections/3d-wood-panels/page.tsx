...
const categories: { key: "All" | Category; label: string }[] = [
  { key: "All", label: "All" },
  { key: "Linear / Fluted", label: "Linear / Fluted" },
  { key: "Geometric / Grid", label: "Geometric / Grid" },
  { key: "Wave / Ripple", label: "Wave / Ripple" },
  { key: "Organic Carved", label: "Organic Carved" },
];

export default function ThreeDWoodPanelsCollectionPage() {
