  ...
  return (
    <div className="min-h-screen bg-white" lang={locale} dir={localeDirections[locale]}>
      <section className="relative bg-gradient-to-br from-[#0F6B3A] via-[#124B34] to-[#0F5C33] py-20 lg:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8">{copy.intro}</p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href={`${contactHref}?type=sample`} className="inline-flex items-center px-8 py-4 bg-white text-[#0F6B3A] font-semibold rounded-full hover:bg-beige transition-colors">
                {copy.contactSamples}
              </Link>
              <Link href={contactHref} className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 transition-colors">
                {copy.sendInquiry}
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl lg:text-3xl font-bold text-[#1F2621] mb-8 text-center">{copy.serviceInfo}</h2>
      ...
      <section className="py-16 bg-[#FDFBF7]">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl lg:text-3xl font-bold text-[#1F2621] mb-4">{copy.ctaTitle}</h2>
            <p className="text-[#6b7280] mb-8">{copy.ctaDescription}</p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href={`${contactHref}?type=sample`} className="inline-flex items-center px-8 py-4 bg-[#0F6B3A] text-white font-semibold rounded-full hover:bg-[#124B34] transition-colors">
                {copy.requestSamples}
              </Link>
              <Link href={getSiteLink("/products", locale)} className="inline-flex items-center px-8 py-4 border-2 border-[#0F6B3A] text-[#0F6B3A] font-semibold rounded-full hover:bg-[#0F6B3A] hover:text-white transition-colors">
                {copy.viewProducts}
              </Link>
            </div>
          </div>
