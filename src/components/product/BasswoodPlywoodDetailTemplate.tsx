      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <Link href="/products/supporting-boards" className="hover:text-[#0F6B3A]"><T>{"Basswood Plywood"}</T></Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            ...
            {relatedProducts.length > 0 ? (
              ...
              placeholderRelatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="inline-flex items-center rounded-full bg-[#F7F3EC] px-3 py-1 text-[11px] font-medium text-[#0F6B3A]"><T>{"Basswood Plywood"}</T></span>
                    <h3 className="font-semibold text-[#1F2621] mt-3 mb-2 line-clamp-2"><T>{"Related Product"}</T></h3>
                    <p className="text-sm text-[#6b7280] line-clamp-3"><T>{"More basswood plywood products will appear here."}</T></p>
                  </div>
                </div>
              ))
            )}
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Basswood Plywood Manufacturer"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Lightweight and easy-to-process plywood for crafts, laser cutting, models and decorative projects."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Tongli Timber supplies basswood plywood for craft manufacturers, laser cutting workshops, model makers, toy producers, packaging suppliers and DIY material distributors. With a light color, smooth surface and uniform texture, basswood plywood is easy to cut, engrave, carve and process, making it a practical material for detailed wood products and creative applications."}</T></p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Real Basswood Plywood Photos for Quality Checking"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Check surface smoothness, board color, edge structure and panel details before ordering."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our real product photos show the natural light color, clean surface and layered plywood structure of basswood plywood. The smooth face and neat edge quality make it suitable for laser cutting, craft processing, model production and decorative use. Samples can be arranged before bulk orders to confirm thickness, size, surface quality and cutting performance."}</T></p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Smooth Surface and Easy Processing Performance"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"A lightweight plywood material designed for clean cutting, carving and creative production."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Basswood plywood is widely used because of its fine texture, light weight and easy processing performance. The smooth double-side sanding helps support painting, printing, engraving and further finishing. Clean cutting edges and uniform board structure make it suitable for detailed patterns, small parts and precision craft production."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Ideal for Crafts, Models, Toys and Creative Wood Products"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"A popular plywood material for laser cutting, DIY projects and detailed decorative parts."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Basswood plywood is commonly used for model aircraft, wooden puzzles, craft houses, decorative ornaments, educational toys, DIY kits, gift packaging, signage and small wooden products. Its light color and easy cutting performance make it especially suitable for laser cutting workshops and creative product manufacturers."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Controlled Production Process for Stable Basswood Plywood Quality"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"From veneer selection to pressing, sanding and inspection, each step supports consistent supply."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our basswood plywood production includes selecting and grading, core assembling, adjusting, cold pressing, repairing, veneer laminating, hot pressing, edge cutting, sanding, quality inspection and packing. Through controlled production steps, we help ensure stable board structure, smoother surface quality and better processing performance for cutting, carving and craft applications."}</T></p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Standard and Custom Sizes for Craft and Bulk Production"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Flexible dimensions for samples, laser cutting, model making and distributor orders."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"We provide both small-format and standard-size basswood plywood to meet different production needs. Small sizes are suitable for craft kits, laser cutting, DIY products and sample testing, while standard panels can support bulk processing and further cutting by manufacturers or distributors."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Export Packaging for Samples, Small Orders and Bulk Shipments"}</T></h2>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-[#6b7280] mt-3 sm:mt-4 text-xs sm:text-sm"><T>{"Everything you need to know about our basswood plywood"}</T></p>
            </div>
