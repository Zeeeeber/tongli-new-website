...
const sidebarCategories: SidebarCategory[] = [
  ...
  { name: "Veneer Edge Banding", href: "/products/veneer-edge-banding", active: true },
  {
...
export function VeneerEdgeBandingDetailTemplate({
  product,
  slug,
}: VeneerEdgeBandingDetailTemplateProps) {
      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <Link href="/products/veneer-edge-banding" className="hover:text-[#0F6B3A]"><T>{"Veneer Edge Banding"}</T></Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.length > 0 ? (
              relatedProducts.map((relatedProduct) => {
                ...
                const relatedLabel = relatedProduct.specs.veneerSpecies || relatedProduct.tags[0] || "Veneer Edge Banding";

                return (
                  <Link
                    key={relatedProduct.slug}
                    href={`/products/veneer-edge-banding/${relatedProduct.slug}`}
              ...
              placeholderRelatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="inline-flex items-center rounded-full bg-[#F7F3EC] px-3 py-1 text-[11px] font-medium text-[#0F6B3A]"><T>{"Veneer Edge Banding"}</T></span>
                    <h3 className="font-semibold text-[#1F2621] mt-3 mb-2 line-clamp-2"><T>{"Related Product"}</T></h3>
                    <p className="text-sm text-[#6b7280] line-clamp-3"><T>{"More veneer edge banding products will appear here."}</T></p>
                  </div>
                </div>
              ))
            )}
            ...
            <div>
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="flex-1">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Veneer Edge Banding Manufacturer"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Real wood veneer edge banding for furniture, doors, cabinets and decorative panels."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Tongli Timber supplies natural wood veneer edge banding for furniture manufacturers, door factories, cabinet producers and wood panel distributors. Our edge banding can be matched with veneer plywood, wood veneer panels, melamine boards and other decorative panels, helping customers achieve a consistent wood grain effect from panel surface to edge detail."}</T></p>
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="flex-1 order-1 md:order-2">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Flexible Edge Banding for Smooth Application"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Designed for curved edges, straight edges and common furniture processing needs."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our veneer edge banding has good flexibility and can be used for both straight and curved edge applications. It supports manual application and machine edge banding, making it suitable for different production workflows. With uniform primer on the back, it helps improve bonding performance during installation."}</T></p>
              ...
              <section className="py-10 sm:py-16 bg-white">
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="flex-1">
                      <p className="text-[10px] sm:text-xs font-semibold text-[#0F6B3A] uppercase tracking-wider mb-2 sm:mb-3"><T>{"Product Advantages"}</T></p>
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Matched Color and Reliable Surface Performance"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Helping furniture edges match the main panel surface more naturally."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"A good edge banding solution should not only cover the board edge, but also match the panel surface in color, grain and texture. We support color matching according to customer samples, helping manufacturers create a more unified and premium final product. The veneer edge banding also offers good flexibility, wear resistance and impact resistance for daily furniture use."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="flex-1 order-1 md:order-2">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Widely Used in Furniture, Cabinets and Interior Panels"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"A practical edge finishing material for modern wood products."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Veneer edge banding is widely used for wardrobes, cabinets, drawers, shelves, doors, tables, wall panels and customized furniture. It helps cover exposed board edges and creates a natural wood finish that matches the main panel surface. Whether used for residential furniture or commercial interior projects, edge banding is an important detail for improving the final product appearance."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
              ...
              <section className="py-10 sm:py-16 bg-white">
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="flex-1">
                      <p className="text-[10px] sm:text-xs font-semibold text-[#0F6B3A] uppercase tracking-wider mb-2 sm:mb-3"><T>{"Wood Veneer Species"}</T></p>
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Multiple Wood Species for Different Panel Designs"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Choose matching veneer edge banding according to your panel surface and market style."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"We provide veneer edge banding in different wood species and colors to match various decorative panels. Common options include okoume, white oak, red oak, rosewood, American cherry, natural black walnut, sapeli, teak and cedar wood. Custom species and colors can also be discussed according to customer samples or project requirements."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="flex-1 order-1 md:order-2">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"A Decorative Wood Material Supplier Since 1999"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Supporting customers with veneer, veneer panels and matching edge banding solutions."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Dongguan Tongli Timber Products Co., Ltd. was established in 1999 and specializes in natural wood veneer, veneer plywood, fancy plywood, UV coated panels, 3D wood panels and veneer edge banding. With years of experience in veneer processing and decorative panel production, we help global buyers source matching panel and edge banding materials from one supplier."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Stable quality, accurate matching and smooth communication support long-term cooperation."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"For furniture and panel manufacturers, edge banding matching is an important detail. Customers choose us because we can help match veneer edge banding with panel surfaces, confirm samples before bulk orders, and provide practical communication throughout the production process. From sample approval to shipment, we focus on reducing sourcing risk for overseas buyers."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="flex-1 order-1 md:order-2">
                      ...
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"For international buyers, supplier qualification and product documents are important for purchasing decisions. Tongli Timber can provide related certificates, test reports and company documents according to different market and project requirements, helping customers reduce sourcing risk and complete supplier approval more efficiently."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="flex-1">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Controlled Production Process for Stable Edge Banding Quality"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"From gluing and laminating to slitting, joining and inspection, each step supports consistent supply."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our veneer edge banding production includes gluing, laminating, hot pressing, slitting, joining, cutting, quality inspection and shipping. By controlling each production step, we help ensure stable bonding, consistent roll width, smooth surface appearance and reliable processing performance for furniture and panel manufacturers."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                  <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    ...
                    <div className="flex-1 order-1 md:order-2">
                      ...
                      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Flexible Packaging for Samples, Small Orders and Bulk Shipments"}</T></h2>
                      <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Protecting veneer edge banding during storage, handling and international transportation."}</T></p>
                      <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Veneer edge banding is usually supplied in rolls, so proper packaging is important to prevent deformation, moisture and surface damage during transportation. We provide catalog support, sample packaging, small order packaging and bulk shipment packaging according to customer needs. Packaging can be adjusted for distributors, furniture factories and project buyers."}</T></p>
                      <div className="grid grid-cols-1 gap-2 sm:gap-3">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-[#6b7280] mt-3 sm:mt-4 text-xs sm:text-sm"><T>{"Everything you need to know about our veneer edge banding"}</T></p>
            </div>
...
export default VeneerEdgeBandingDetailTemplate;
