      ...
      <section className="py-16 bg-[#8B5E3C]">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center text-white">
            <h2 className="text-3xl font-bold mb-4"><T>{"Need Natural Wood Veneer?"}</T></h2>
            <p className="text-white/80 mb-8"><T>{"Contact us for species availability, custom specifications, and sample requests."}</T></p>
