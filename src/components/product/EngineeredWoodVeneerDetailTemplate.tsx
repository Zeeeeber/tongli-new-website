            ...
            {relatedProducts.length > 0 ? (
              ...
              placeholderRelatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="inline-flex items-center rounded-full bg-[#F7F3EC] px-3 py-1 text-[11px] font-medium text-[#0F6B3A]">Engineered Wood Veneer</span>
                    <h3 className="font-semibold text-[#1F2621] mt-3 mb-2 line-clamp-2">Related Product</h3>
                    <p className="text-sm text-[#6b7280] line-clamp-3">More engineered wood veneer products will appear here.</p>
                  </div>
                </div>
              ))
            )}
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Engineered Wood Veneer Manufacturer</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Supplying reconstituted wood veneer sheets with consistent patterns for furniture, doors, panels and interior projects.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Tongli Timber supplies engineered wood veneer (reconstituted veneer) with 300+ consistent patterns, stable colors, and uniform textures. From pattern selection and color matching to backing options, packing and export delivery, we help furniture manufacturers, door factories, panel producers and interior project buyers source stable and beautiful veneer materials for production.</p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Engineered Wood Veneer Sheets for Selection</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Consistent grain, stable color and real material details before order confirmation.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Engineered wood veneer offers consistent grain patterns and stable colors across all sheets. Our real product photos help customers check veneer appearance, pattern consistency, sheet quality and color tone before placing orders. Whether you need oak, walnut, ash, teak or other reconstituted patterns, we can provide sample photos, catalog references and physical samples for approval.</p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Engineered Wood Veneer for High-end Interior Surfaces</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">A flexible decorative material with consistent patterns for furniture, wall panels, doors and custom interiors.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Engineered wood veneer is widely used in furniture, wooden doors, cabinets, wardrobes, wall cladding, hotel interiors and full-house customization projects. It offers consistent patterns while maintaining the aesthetic of natural wood, with better material efficiency and batch-to-batch uniformity. With different patterns and backing options, customers can create warm, elegant and customized interior surfaces.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Experienced manufacturer for engineered veneer, natural veneer, veneer panels and decorative wood materials.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Dongguan Tongli Timber Products Co., Ltd. was established in 1999 and specializes in engineered wood veneer, natural wood veneer, veneer plywood, fancy plywood, UV coated veneer panels and 3D wood panels. With years of production experience and export service, we support global customers with stable material supply, customized processing and professional communication.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1">
                ...
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Many customers choose us again because of stable veneer quality, consistent patterns, clear communication and practical support during sourcing. From sample checking to bulk order delivery, we help buyers confirm patterns, veneer thickness, backing options, edge banding compatibility and packaging requirements.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-[#6b7280] mt-3 sm:mt-4 text-xs sm:text-sm">Everything you need to know about our engineered wood veneer</p>
            </div>
