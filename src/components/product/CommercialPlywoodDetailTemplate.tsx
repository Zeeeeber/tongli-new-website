...
interface CommercialPlywoodDetailTemplateProps {
...
export function CommercialPlywoodDetailTemplate({
  product,
  slug,
}: CommercialPlywoodDetailTemplateProps) {
      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <Link href="/products/supporting-boards" className="hover:text-[#0F6B3A]"><T>{"Commercial Plywood"}</T></Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.length > 0 ? (
              relatedProducts.map((relatedProduct) => {
                ...
                const relatedLabel = (relatedProduct as { subCategory?: string }).subCategory || relatedProduct.specs.veneerSpecies || relatedProduct.tags[0] || "Commercial Plywood";
              ...
              placeholderRelatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="inline-flex items-center rounded-full bg-[#F7F3EC] px-3 py-1 text-[11px] font-medium text-[#0F6B3A]"><T>{"Commercial Plywood"}</T></span>
                    <h3 className="font-semibold text-[#1F2621] mt-3 mb-2 line-clamp-2"><T>{"Related Product"}</T></h3>
                    <p className="text-sm text-[#6b7280] line-clamp-3"><T>{"More commercial plywood products will appear here."}</T></p>
                  </div>
                </div>
              ))
            )}
              ...
              <table className="w-full min-w-[600px]">
                <tbody>
                  {[
                    ...
                    { label: "Product Name", value: "Commercial Plywood / Commercial Plywood Board / Furniture Grade Plywood / Okoume Plywood / Ev Commercial Plywood / Interior Commercial Plywood" },
                    { label: "Plywood Types", value: "Ev Faced Plywood / Okoume Faced Plywood" },
                    { label: "Core", value: "Mainly Eucalyptus" },
                    ...
                    { label: "Standard Thickness", value: "3.0Mm/5Mm/9Mm/12Mm/15Mm/18Mm/25Mm" },
                    { label: "Surface Finish", value: "Raw/Sanded/Laminated" },
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Commercial Plywood Manufacturer"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Stable plywood panels for furniture, cabinets, interiors, packaging and commercial projects."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Tongli Timber supplies commercial plywood for furniture manufacturers, cabinet factories, door producers, interior contractors, distributors and project buyers. With stable core structure, smooth surface and customizable size, thickness and glue options, our plywood panels are suitable for cutting, laminating, sanding, painting and further processing."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3 mb-6 sm:mb-8">
                  {["Commercial plywood for furniture and interior use", "Smooth surface and stable board structure", "Standard and extended sizes available", "Custom thickness and glue options", "Suitable for cabinets, shelves, wall panels and packaging", "Factory direct supply with export packaging support"].map((point) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Real Commercial Plywood Photos for Quality Checking"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Check surface smoothness, panel edge and core structure before bulk ordering."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our real product photos show the surface appearance, plywood edge, core layers and overall board quality from different angles. Commercial plywood is widely selected because of its practical structure, good processing performance and cost-effective material value. Before bulk production, customers can confirm samples, thickness, surface quality and application requirements."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Sample confirmation before mass production", "Surface and edge quality checking", "Furniture and cabinet material approval", "Distributor product catalog reference", "Bulk order quality comparison"].map((item) => (
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Stable Quality for Furniture and Commercial Use"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Controlled moisture, smooth surface and reliable processing performance."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Commercial plywood needs to maintain stable quality during cutting, drilling, sanding, laminating and furniture production. Our plywood is produced with controlled moisture content, practical thickness tolerance and smooth surface quality. Clean panel edges and fewer visible defects help improve processing efficiency and final product appearance."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Moisture content controlled at around 7%–12%", "Thickness tolerance can be controlled around ±0.5mm", "Smooth surface for finishing or lamination", "Clean panel sides with fewer defects", "Suitable for cutting, sanding and further processing", "Practical material choice for furniture and interior production"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
        ...
        <section className="py-10 sm:py-16 bg-[#FDFBF7]">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                <p className="text-[10px] sm:text-xs font-semibold text-[#0F6B3A] uppercase tracking-wider mb-2 sm:mb-3"><T>{"Application"}</T></p>
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3"><T>{"Widely Used in Furniture, Interior Decoration and Commercial Projects"}</T></h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"A versatile plywood material for both visible and structural applications."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Commercial plywood is widely used in furniture production, cabinets, shelves, wall panels, ceilings, partitions, shop decoration, packaging and general interior projects. It can be used as a base panel, structural board or decorative panel after lamination with veneer, melamine, HPL or other surface materials."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Furniture and cabinet manufacturing", "Shelves, drawers and storage systems", "Wall panels and ceiling decoration", "Commercial interiors and shop fitting", "Door components and interior partitions", "Packaging, crates and general panel use"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Supporting global buyers with plywood, veneer panels and customized wood-based materials."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Dongguan Tongli Timber Products Co., Ltd. was established in 1999 and specializes in plywood, veneer plywood, fancy plywood, natural wood veneer, engineered veneer, UV coated panels and other decorative wood-based materials. With years of production experience and export service, we provide stable plywood solutions for furniture factories, distributors, contractors and project buyers worldwide."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Established in 1999", "Experienced in plywood and veneer panel production", "Support for samples, customization and bulk orders", "Multiple size, thickness and glue options available", "Export packaging and container loading support", "Serving furniture, interior and commercial project customers"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our customers value stable plywood quality, accurate sample confirmation and reliable shipment support. From plywood grade selection to size, thickness, glue, packaging and delivery communication, we help overseas buyers reduce sourcing risk and make the purchasing process more efficient."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Clear sample confirmation before production", "Stable plywood quality for repeat orders", "Accurate size and thickness communication", "Matched surface and edge banding options", "Reliable packaging for international shipping", "Support for long-term supply cooperation"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"Our commercial plywood production includes veneer selecting and grading, core assembling, adjusting, veneer laminating, repairing, cold pressing, hot pressing, edge cutting, sanding, quality inspection and packaging. Through controlled production steps, we help ensure stable board structure, better bonding quality and smoother surface performance."}</T></p>
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  {["Veneer selecting and grading", "Core assembling", "Adjusting and repairing", "Veneer laminating", "Cold pressing", "Hot pressing", "Edge cutting", "Sanding", "Quality inspection", "Packaging and shipment preparation"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic"><T>{"Flexible plywood dimensions for furniture production, interior projects and bulk orders."}</T></p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6"><T>{"We support standard and customized commercial plywood sizes according to different production needs. The common size is 2440×1220mm, while extended sizes can be supplied for wall panels, doors, furniture parts and special project applications. Thickness and glue options can also be adjusted according to customer requirements."}</T></p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {["Sample size: 300×200mm", "Standard size: 2440×1220mm", "Extended sizes: 2600×1220mm, 2800×1220mm, 3050×1220mm", "Custom size available upon request", "Custom thickness available according to order requirements", "Glue options: ENF / E0 / E1 / E2 available"].map((item) => (
                    <div key={item} className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[#0F6B3A]/10 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 h-3 text-[#0F6B3A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-[#6b7280] mt-3 sm:mt-4 text-xs sm:text-sm"><T>{"Everything you need to know about our commercial plywood"}</T></p>
            </div>
...
export default CommercialPlywoodDetailTemplate;
