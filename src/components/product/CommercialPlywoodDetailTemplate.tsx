      ...
      <div className="bg-[#F7F3EC] py-4">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-2 text-sm text-[#6b7280]">
            ...
            <Link href="/products/supporting-boards" className="hover:text-[#0F6B3A]">Commercial Plywood</Link>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            ...
            {relatedProducts.length > 0 ? (
              ...
              placeholderRelatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="inline-flex items-center rounded-full bg-[#F7F3EC] px-3 py-1 text-[11px] font-medium text-[#0F6B3A]">Commercial Plywood</span>
                    <h3 className="font-semibold text-[#1F2621] mt-3 mb-2 line-clamp-2">Related Product</h3>
                    <p className="text-sm text-[#6b7280] line-clamp-3">More commercial plywood products will appear here.</p>
                  </div>
                </div>
              ))
            )}
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Commercial Plywood Manufacturer</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Stable plywood panels for furniture, cabinets, interiors, packaging and commercial projects.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Tongli Timber supplies commercial plywood for furniture manufacturers, cabinet factories, door producers, interior contractors, distributors and project buyers. With stable core structure, smooth surface and customizable size, thickness and glue options, our plywood panels are suitable for cutting, laminating, sanding, painting and further processing.</p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Real Commercial Plywood Photos for Quality Checking</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Check surface smoothness, panel edge and core structure before bulk ordering.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Our real product photos show the surface appearance, plywood edge, core layers and overall board quality from different angles. Commercial plywood is widely selected because of its practical structure, good processing performance and cost-effective material value. Before bulk production, customers can confirm samples, thickness, surface quality and application requirements.</p>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Stable Quality for Furniture and Commercial Use</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Controlled moisture, smooth surface and reliable processing performance.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Commercial plywood needs to maintain stable quality during cutting, drilling, sanding, laminating and furniture production. Our plywood is produced with controlled moisture content, practical thickness tolerance and smooth surface quality. Clean panel edges and fewer visible defects help improve processing efficiency and final product appearance.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 order-1 md:order-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#1F2621] mb-3">Widely Used in Furniture, Interior Decoration and Commercial Projects</h2>
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">A versatile plywood material for both visible and structural applications.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">Commercial plywood is widely used in furniture production, cabinets, shelves, wall panels, ceilings, partitions, shop decoration, packaging and general interior projects. It can be used as a base panel, structural board or decorative panel after lamination with veneer, melamine, HPL or other surface materials.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#8B5E3C] mb-4 sm:mb-6 italic">Flexible plywood dimensions for furniture production, interior projects and bulk orders.</p>
                <p className="text-[#6b7280] text-sm leading-relaxed mb-4 sm:mb-6">We support standard and customized commercial plywood sizes according to different production needs. The common size is 2440×1220mm, while extended sizes can be supplied for wall panels, doors, furniture parts and special project applications. Thickness and glue options can also be adjusted according to customer requirements.</p>
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-[#6b7280] mt-3 sm:mt-4 text-xs sm:text-sm">Everything you need to know about our commercial plywood</p>
            </div>
